...
/** Chispa, brillo y fondo compartidos por el botón y el enlace. */
...
>(
  (
    ...
    return (
      <button
        style={{
          ...shimmerVars({ shimmerColor, shimmerSize, shimmerDuration, borderRadius, background }),
          ...style,
        }}
...
/** Misma apariencia que `ShimmerButton`, pero navega: un `<a>` real. */
